...
dir_design = file.path(script_dir, "data", "design", "small_leucegene", "inv16_vs_t15_17")
...
for (i in c(1:20)) {
  selected_subgroup = sample(1:length(uniq_subg), 30, replace=T)
  ...
  dir_rand = file.path(script_dir, "data", "design", "small_leucegene_random", i)
