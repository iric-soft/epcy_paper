...
dir_design = file.path(script_dir, "data", "design", "10X_FACS_reduce", "all")
...
for (i in c(1:20)) {
  selected_subgroup = sample(1:length(uniq_subg), 1000, replace=T)
  ...
  dir_rand = file.path(script_dir, "data", "design", "10X_FACS_reduce_random", i)
