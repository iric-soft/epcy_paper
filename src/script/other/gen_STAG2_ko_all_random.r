...
dir_design = file.path(script_dir, "data", "design", "STAG2_ko_all", "all")
...
for (i in c(1:20)) {
  selected_subgroup = sample(1:length(uniq_subg), 10000, replace=T)
  ...
  dir_rand = file.path(script_dir, "data", "design", "STAG2_ko_all_random", i)
