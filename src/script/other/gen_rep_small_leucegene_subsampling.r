...
sub_sampling <- function(p, design, name_design, num, script_dir, samples_rep) {
  ...
  dir_ss = file.path(script_dir, "data", "design", "small_leucegene_rep_ss", name_design, p, num)
...
foreach_design <- function(name_design, p_subs, script_dir, nums, samples_rep) {
  dir_design = file.path(script_dir, "data", "design", "small_leucegene", name_design)
...
file_mat = file.path(script_dir, "data", "small_leucegene", "STAR_RSEM", "readcounts.xls")
...
dir_nat_rep = file.path(script_dir, "data", "small_leucegene_rep", "STAR_RSEM")
